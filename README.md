...
3. Go to the configurations-tab and enter all the required details, such as the IP address and port when using a remote RS485 device, or the locally available serial-port, number of battery packs etc.
4. Press save
5. Run the Add-on and check the logs. The should look like:
